    ...
    <div class="onboarding-section-body">
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <input type="text" name="address_street" class="form-control @error('address_street') is-invalid @enderror" placeholder="Street" value="{{ old('address_street') }}">
                @error('address_street')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-4">
                <input type="text" name="address_city" class="form-control @error('address_city') is-invalid @enderror" placeholder="City" value="{{ old('address_city') }}">
                @error('address_city')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-4">
                <input type="text" name="address_state" class="form-control @error('address_state') is-invalid @enderror" placeholder="State" value="{{ old('address_state') }}">
                @error('address_state')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-4">
                <input type="text" name="address_zip" class="form-control @error('address_zip') is-invalid @enderror" placeholder="ZIP" value="{{ old('address_zip') }}">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <input type="text" name="sex" class="form-control @error('sex') is-invalid @enderror" value="{{ old('sex') }}">
            ...
            <div class="col-md-4">
                ...
                <select name="is_felon" class="form-select @error('is_felon') is-invalid @enderror">
