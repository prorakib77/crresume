...
<div x-data="{ filtersOpen: false }" @keydown.escape.window="filtersOpen = false" class="work-updates-shell">
    <div class="work-updates-toolbar">
        <div>
            ...
            <h2 class="theme-display work-updates-heading">My Work Update History</h2>
            <p class="work-updates-copy">Review your submissions.</p>
        </div>

        <div class="work-updates-toolbar-actions">
            <a href="{{ route('agent.work-updates.create') }}" class="btn btn-primary">
                <i class="fas fa-plus me-2"></i>Submit New Update
            </a>
        ...
        <div class="work-update-filter-drawer-inner">
            ...
            <div class="work-update-filter-drawer-body">
                <div class="work-update-filter-group">
                    <label class="form-label" for="agent_live_search">Search</label>
                    <input id="agent_live_search" type="text" class="form-control" placeholder="Client, company, title, or note" wire:model.live="search">
                </div>
                ...
                <table class="table table-hover mobile-data-table">
                    ...
                    <tbody>
                        @forelse($workUpdates as $update)
                            <tr wire:key="agent-work-update-{{ $update->id }}">
                                <td data-label="Date" data-stack="true">
                                    <div>
                                ...
                                <td data-label="Job" data-stack="true">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-4">
                                    ...
                                    <a href="{{ route('agent.work-updates.create') }}" class="btn btn-primary mt-2">
                                        <i class="fas fa-plus me-2"></i>Submit Your First Update
                                    </a>
                                </td>
                            </tr>
                        @endforelse
